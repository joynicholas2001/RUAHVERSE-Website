  ...
  const [projects] = React.useState([
    {
      ...
      liveUrl: "https://zionicarc.com"
    },
    {
      id: 2,
      title: "E-Commerce Application",
      description: "A robust and scalable e-commerce platform featuring seamless checkout, real-time inventory management, and intuitive user experiences for maximum conversion.",
      image: "https://images.unsplash.com/photo-1556742049-0cfed4f6a45d?q=80&w=2070&auto=format&fit=crop",
      technologies: ["React JS", "Node JS"],
      features: ["Secure Payments", "Inventory Management", "User Analytics", "Mobile Responsive"],
      liveUrl: "#"
    }
  ]);
  ...
  return (
    <section id="projects" className="py-16 md:py-32 bg-slate-50/50 relative overflow-hidden">
      ...
      <div className="container-custom relative z-10">
        ...
        <div className="grid grid-cols-1 gap-8 md:gap-12 mb-16 md:mb-32 max-w-7xl mx-auto">
