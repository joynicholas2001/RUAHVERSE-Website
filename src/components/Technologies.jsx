  ...
  const techCategories = [
    {
      ...
      technologies: [
        { name: "React / Next.js", icon: <div className="flex items-center gap-2"><FaReact className="text-[#61DAFB]" /><SiNextdotjs className="text-slate-200" /></div>, color: "" },
        { name: "TypeScript", icon: <SiTypescript />, color: "text-blue-600" },
        { name: "Tailwind CSS", icon: <SiTailwindcss />, color: "text-cyan-500" },
        { name: "Framer Motion", icon: <SiFramer />, color: "text-violet-600" }
      ]
    },
    {
      title: "Backend Core",
      technologies: [
        ...
        { name: "Python / Django", icon: <div className="flex items-center gap-2"><FaPython className="text-[#3776AB]" /><SiDjango className="text-emerald-500" /></div>, color: "" },
    ...
    },
    {
      ...
      technologies: [
        { name: "Git / GitHub", icon: <div className="flex items-center gap-2"><FaGitAlt className="text-[#F05032]" /><FaGithub className="text-slate-200" /></div>, color: "" },
