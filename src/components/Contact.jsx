        ...
        <div className="grid lg:grid-cols-2 gap-12 md:gap-20 items-center">
          <div className="space-y-8 md:space-y-12">
            ...
            <div className="grid gap-6 md:gap-8">
              {[
                { icon: <FaEnvelope />, title: "Email Inquiry", detail: "contactruahverse@gmail.com", sub: "Response within 24 business hours", link: "mailto:contactruahverse@gmail.com" },
                { icon: <FaPhone />, title: "Voice Call", detail: "+91 9963416422", sub: "Available Mon-Fri, 9am - 6pm", link: "tel:+919963416422" },
                ...
                <div key={idx} className="flex items-start gap-6 group">
                  ...
                  <div className="space-y-1">
                    ...
                    {item.link ? (
                      <a href={item.link} className="text-lg font-black text-slate-800 hover:text-primary-600 transition-colors block">{item.detail}</a>
                    ) : (
